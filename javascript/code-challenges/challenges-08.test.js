...
// const matches_array = order.name.match(regexp);
// console.log(order)
return order;
};
...
input contains the word 'world' all in lower-case letters, and false if the input does not.
